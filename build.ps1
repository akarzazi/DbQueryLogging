...
if ($CreatePackages) {
    ...
    dotnet pack ".\src\DbQueryLogging\DbQueryLogging.csproj" --no-build -p:IncludeSymbols=true -p:SymbolPackageFormat=snupkg -c Release /p:PackageOutputPath=$packageOutputFolder
}
